...
public class GetObtenerFacturasClienteRequest {
	...
	public int getP_num_pag_ini() {
		return p_num_pag_ini;
	}

	public void setP_num_pag_ini(int p_num_pag_ini) {
		this.p_num_pag_ini = p_num_pag_ini;
	}

	@JsonProperty(value = "p_num_pag_fin")
	public int getP_num_pag_fin() {
		return p_num_pag_fin;
	}

	public void setP_num_pag_fin(int p_num_pag_fin) {
